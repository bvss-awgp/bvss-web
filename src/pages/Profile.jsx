...
const Profile = () => {
  ...
  const contributionProfile = useMemo(() => {
    ...
    const personal = [
      { label: "First Name", value: withFallback(contribution?.firstName, "Add your first name") },
      { label: "Last Name", value: withFallback(contribution?.lastName, "Add your last name") },
      {
        label: "Email",
